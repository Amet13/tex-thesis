...
\toprule
\textbf{Alternative} & {\textbf{Score}} \\
\midrule
Monolithic      & 7.15 \\
Microservices    & 7.95 \\
\textbf{Hybrid} & \bfseries 8.30 \\
\bottomrule
\end{tabular}
...
\begin{table}[H]
  \centering
  \begin{tabular}{l S[table-format=1.1] S[table-format=2.1] S[table-format=3.1]}
  \toprule
  \textbf{Method} & {\textbf{Small (s)}} & {\textbf{Medium (s)}} & {\textbf{Large (s)}} \\
  \midrule
  Baseline A       & 0.8 & 45.2 & 512.0 \\
  Baseline B       & 0.5 & 38.7 & 478.3 \\
  \textbf{Proposed} & \bfseries 0.3 & \bfseries 22.1 & \bfseries 287.5 \\
  \bottomrule
  \end{tabular}
\end{table}
