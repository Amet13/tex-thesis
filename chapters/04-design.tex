...
\cref{tab:alternatives} presents a comparison of the three alternatives.

% === EXAMPLE: Complex table with booktabs and siunitx ===
\begin{table}[H]
    \centering
    \caption{Comparison of design alternatives} \label{tab:alternatives}
    \begin{tabular}{l S[table-format=1.2] c c c}
    \toprule
    \textbf{Criterion} & {\textbf{Weight}} & \textbf{Monolithic} & \textbf{Microservices} & \textbf{Hybrid} \\
    \midrule
    Performance  & 0.30 & 8 & 7 & 9 \\
    Accuracy     & 0.25 & 9 & 8 & 9 \\
    Scalability  & 0.25 & 5 & 9 & 8 \\
    Maintainability & 0.20 & 6 & 8 & 7 \\
    \midrule
    \textbf{Weighted score} & {---} & \textbf{7.15} & \textbf{7.95} & \textbf{8.30} \\
    \bottomrule
    \end{tabular}
\end{table}
...
The implementation timeline is shown in \cref{fig:timeline}.
